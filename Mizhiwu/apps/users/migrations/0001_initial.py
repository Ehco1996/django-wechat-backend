# Generated by Django 2.0.1 on 2018-02-16 20:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(help_text='用户ID', on_delete=django.db.models.deletion.CASCADE, related_name='code_owner', to=settings.AUTH_USER_MODEL, verbose_name='创建者')),
            ],
            options={
